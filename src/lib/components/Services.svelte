	...
	<div class="bg-muted/30 space-y-8 rounded-xl p-2 md:p-2">
		...
		<div class="grid gap-2 sm:grid-cols-2">
			<Card class="group hover:bg-background/50 cursor-pointer transition-all hover:shadow-lg">
				...
				<CardContent class="pt-0">
					<p class="text-card-foreground">
						<strong class="text-primary">Secure Funding.</strong> Turn your pitch into an undeniable
						demonstration of value with a product animation that proves your concept is brilliant and
						ready.
					</p>
				</CardContent>
			</Card>
			...
			<Card class="group hover:bg-background/50 cursor-pointer transition-all hover:shadow-lg">
				...
				<CardContent class="pt-0">
					<p class="text-card-foreground">
						<strong class="text-primary">Drive Sales.</strong> Scroll‑stopping content that turns dense
						features into must‑have benefits and boosts conversion.
					</p>
				</CardContent>
			</Card>
			...
			<Card class="group hover:bg-background/50 cursor-pointer transition-all hover:shadow-lg">
				...
				<CardContent class="pt-0">
					<p class="text-card-foreground">
						<strong class="text-primary">Impress Clients.</strong> Move beyond static blueprints with
						photorealistic renders that showcase every detail and win fast approval.
					</p>
				</CardContent>
			</Card>
		</div>
